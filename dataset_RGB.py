...
def is_image_file(filename):
    return any(filename.endswith(extension) for extension in ['jpeg', 'JPEG', 'jpg', 'png', 'JPG', 'PNG', 'gif', 'tiff']) # luis: I added TIFF
...
class DataLoaderTrain(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #w, h = tar_img.size #luis comment
        w,h,l = np.shape(tar_img) # luis: for numpy array shape
